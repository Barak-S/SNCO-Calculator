...
export default class CurrencyInput extends Component {
    ...
    render() {
        ...
        if (this.props.input === "currency"){
            ...
            input = <FormControl autoComplete="new-password" name={this.props.name} value={this.props.value || undefined} onChange={(e)=>this.props.handleChange(this.props.name ,e.target.value)}></FormControl>
        }
        return (
                input
        )
